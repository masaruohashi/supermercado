        ...
        <div class="col-sm-6 col-sm-offset-3 js-user-seller">
          <form action="clientes" method="POST" class="form-group">            
            ...
            <div class="row">
              ...
              <% } else { %>
                <label>Nome:</label>
                <input class="form-control" type="text" name="name" value="<%=client.getName()%>"/>
                <br>
                <label>CPF:</label>
                <input class="form-control" type="text" name="cpf" value="<%=client.getCpf()%>"/>
                <br>
                <label>Endereço:</label>
                <input class="form-control" type="text" name="address" value="<%=client.getAddress()%>"/>
            ...
            <div class="row">
              <div class="col-sm-6 col-sm-offset-6">
                <div class="row">
                  <div class="col-sm-6">
                    <a class="btn btn-warning pull-right" href="clientes">Cancelar</a>
                  </div>
                  <div class="col-sm-6">
